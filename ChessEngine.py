...
class GameState:
    def __init__(self):
        ...
        self.isLateGame = False
        self.moreDepth = 0

    def makeMove(self, move, is_human=False):
        """
    ...
    def isItLateGame(self):
        queen_w = 0
        queen_b = 0
        pieces_w = 0
        pieces_b = 0
        for index in range(0,64):
            CaseTest = self.board[index//8][index % 8]
            if CaseTest == "bQ":
                queen_w = 1
            elif CaseTest == "wq": 
                queen_b = 1   
            elif CaseTest == "bR" or CaseTest == "bN" or CaseTest == "bB":
                pieces_w += 1   
            elif CaseTest == "wr" or CaseTest == "wk" or CaseTest == "wb":
                pieces_b += 1  

        if queen_b == 0 and queen_w == 0:
            self.isLateGame = True
        elif queen_w == 1 and pieces_w < 2:
            self.isLateGame = True
        elif queen_b == 1 and pieces_b < 2:
            self.isLateGame = True
        else:
            self.isLateGame = False          

    def isMoreDepth(self):
